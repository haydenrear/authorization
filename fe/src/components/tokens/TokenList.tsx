            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-900 truncate">{token.scope}</p>
                </div>
              </div>
            </div>

            <div className="flex gap-2 flex-shrink-0">
              <TokenCopyButton token={token.jti} label="Copy ID" />
              <TokenRevokeButton
                tokenName={token.name}
                onRevoke={() => onRevoke(token.jti)}
              />
            </div>
          </div>
        </div>
